...
import { updateStudent } from '@/actions/owner/students'
...
export function EditStudentModal({ isOpen, onClose, student }: EditStudentModalProps) {
    ...
    async function handleSubmit(formData: FormData) {
        ...
        // Append controlled inputs manually if needed, 
        // but since they have 'name' attribute and are in the form, 
                            ...
                            <div className="p-6 overflow-y-auto">
                                <form id="edit-student-form" action={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="md:col-span-2">
                                        <h3 className="text-sm font-medium text-gray-500 mb-4 uppercase tracking-wider">Personal Details</h3>
                                    </div>
                                    ...
                                    <FormInput
                                        ...
                                        label="Date of Birth"
                                        type="date"
                                        defaultValue={formatDate(student.dob)}
                                    />
