...
export function TopBar({ user, title, className, onMenuClick, onLogout }: TopBarProps) {
  ...
  return (
    <header className={cn(
      "sticky top-0 z-30 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-700 px-4 py-3 md:px-6 flex items-center justify-between",
      className
    )}>
