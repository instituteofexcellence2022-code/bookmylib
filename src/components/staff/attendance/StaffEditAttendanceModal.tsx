...
import { updateStaffAttendanceRecord } from '@/actions/staff/attendance'
...
interface StaffEditAttendanceModalProps {
...
export function StaffEditAttendanceModal({ record, onClose, onSuccess }: StaffEditAttendanceModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const result = await updateStaffAttendanceRecord(record.id, {
                checkIn,
                checkOut
            })
